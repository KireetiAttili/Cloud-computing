...
user = '090_094_105_108'           # username as set for the mongodb admin server (the username used in secret.yaml - before base64 conversion)
password = 'qwerty123'       # password as set for the mongodb admin server (the password used in secret.yaml - before base64 conversion)
host = 'mongo-express-service'    # service name of the mongodb admin server as set in the service for mongodb server
port = '8081'              # port number of the mongodb admin server as set in the service for mongodb server
